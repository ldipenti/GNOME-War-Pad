...
H_FILES="src/gwp-object.h src/gwp-flying-object.h src/gwp-planet.h src/gwp-ship.h src/gwp-ion-storm.h src/gwp-engspec.h src/gwp-torpspec.h src/gwp-beamspec.h src/gwp-hullspec.h src/gwp-starbase.h"
